...
```
   implementation 'com.gimbal.android.v4:airship-adapter:7.4.0'
```
...
```
   AirshipAdapter.shared(context).start("## PLACE YOUR API KEY HERE ##");
```
...
```
    AirshipAdapter.shared(context).startWithPermissionPrompt("dae68546-36c5-4c54-9663-447d9e033e4c");
```
